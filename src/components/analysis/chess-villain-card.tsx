...
export function ChessVillainCard({
  ...
  return (
    <section
      id="chess-villain"
      className="rounded-[1.7rem] border border-rose-300/16 bg-[linear-gradient(135deg,rgba(76,5,25,0.48),rgba(15,23,42,0.84)_42%,rgba(2,6,23,0.94))] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.22)]"
    >
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center gap-2 rounded-full border border-rose-300/25 bg-rose-300/12 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-rose-100">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-300">{profile.weakness}</p>
        ...
        <div className="rounded-[1.25rem] border border-white/10 bg-slate-950/55 p-4">
          ...
          <div className="mt-4 rounded-[1rem] border border-amber-300/15 bg-amber-300/8 p-4">
            <p className="flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-amber-200">
              <Sword className="size-4" />
              Antidote
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-100">{profile.antidote}</p>
          </div>
